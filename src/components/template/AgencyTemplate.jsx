export default function Agency({ content }) {
    return (
        <>
            ...
            <section className="py-10 px-10 md:px-30 bg-slate-900 w-full">
            ...
            <section className="hidden md:block py-10 px-10 md:px-30 bg-slate-900 w-full">
            ...
            <section id="CTA" className="bg-blue-800 px-6 md:px-30 py-20">
